...
async function main() {
  ...
  await prisma.user.create({
    data: {
      id: "user-admin",
      email: "admin@galliano.co",
      name: "Jolene Galliano",
      role: "admin",
    },
  });
  ...
  const subs = await Promise.all([
    prisma.subcontractor.create({
      data: { id: "s1", name: "Marcus Delgado", trade: "Roofing", rate: 0.55, color: "#e85a4f", initials: "MD" },
    }),
    prisma.subcontractor.create({
      data: { id: "s2", name: "Priya Shah", trade: "Electrical", rate: 0.50, color: "#6b8cbf", initials: "PS" },
    }),
    prisma.subcontractor.create({
      data: { id: "s3", name: "Dwayne Okafor", trade: "HVAC", rate: 0.52, color: "#4a8a6e", initials: "DO" },
    }),
    prisma.subcontractor.create({
      data: { id: "s4", name: "Elena Koslov", trade: "Plumbing", rate: 0.48, color: "#b58a3d", initials: "EK" },
    }),
    prisma.subcontractor.create({
      data: { id: "s5", name: "Tomás Iglesias", trade: "Carpentry", rate: 0.50, color: "#7b5ea7", initials: "TI" },
    }),
    prisma.subcontractor.create({
      data: { id: "s6", name: "Rachel Chen", trade: "Drywall", rate: 0.45, color: "#3d7a8a", initials: "RC" },
    }),
  ]);
  ...
  const inv1 = await prisma.invoice.create({
    data: {
      id: "inv-1024",
      number: "INV-1024",
      client: "Brookside Estates HOA",
      address: "4410 Willow Creek Dr, Austin TX",
      issued: "2026-04-15",
      due: "2026-05-15",
      source: "FreshBooks",
      lines: {
  ...
  const inv2 = await prisma.invoice.create({
    data: {
      id: "inv-1025",
      number: "INV-1025",
      client: "Mesquite Commons LLC",
      address: "2200 S. Lamar, Austin TX",
      issued: "2026-04-17",
      due: "2026-05-17",
      source: "FreshBooks",
      lines: {
  ...
  const inv3 = await prisma.invoice.create({
    data: {
      id: "inv-1026",
      number: "INV-1026",
      client: "Parkview Medical Group",
      address: "810 Research Blvd, Austin TX",
      issued: "2026-04-20",
      due: "2026-05-20",
      source: "CSV Import",
      lines: {
  ...
  const inv4 = await prisma.invoice.create({
    data: {
      id: "inv-1027",
      number: "INV-1027",
      client: "Greenfield Residential",
      address: "17 unit new build — Cedar Park",
      issued: "2026-04-21",
      due: "2026-05-21",
      source: "FreshBooks",
      lines: {
  ...
  console.log(`Seeded invoices: ${inv1.number}, ${inv2.number}, ${inv3.number}, ${inv4.number}`);
  ...
  console.log("Seeded pay history");
}
